...
import delivery.pipeline.api.job.JobService;
...
public class AspectService {
     ...
     */
    @Before("execution(* delivery..*Service.*(..)) && !execution(* delivery..common.*Service.*(..))")
     ...
     * @param joinPoint the join point
     */
    @Before("execution(* delivery..*Controller.*(..))")
     ...
     */
    @AfterReturning(pointcut = "execution(* delivery.pipeline.api.job.*Service.triggerJob(..))", returning = "result")
